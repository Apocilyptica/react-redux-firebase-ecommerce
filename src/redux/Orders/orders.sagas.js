...
export function* getOrderDetials({ payload }) {
  try {
...
export function* getOrderDetailsStart() {
  yield takeLatest(ordersTypes.GET_ORDER_DETAILS_START, getOrderDetials);
}

export default function* ordersSagas() {
  yield all([call(onSaveOrderHistoryStart), call(OnGetUserOrderHistoryStart), call(getOrderDetailsStart)]);
}
